...
<aside class="app-sidebar">
	<div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?= media(); ?>images/avatar.png" alt="Avatar">
		<div>
			<p class="app-sidebar__user-name">Kevin Monsalve</p>
	...
	<ul class="app-menu">
		...
		<li><a class="app-menu__item" href="<?= base_url() ?>/productos"><i class="app-menu__icon fa fa-archive" aria-hidden="true"></i><span class="app-menu__label">Productos</span></a></li>
